...
*Caption: field-office layout on phone — single column with thin tabs, log, composer, roster strip, and quick bar.*
...
*Caption: Armory lifetime shelves on desktop — ALWAYS-ON gem shelf, empty ON-CALL shelf, scope facets.*
...
*Caption: Armory lifetime shelves on phone — same shelves and facets in the narrow viewport.*
...
*Caption: Character sheet on phone — same Profile drawer in the narrow viewport.*
...
*Caption: quick bar on desktop — Inventory 1, Character 2, New channel 3, Stop 4, gear picker.*
...
*Caption: quick bar on phone — same four slots and gear, ellipsized to fit.*
...
*Caption: thread view on desktop — Thread Major pane with root, intro, leash note, and composer.*
...
*Caption: thread view on phone — same Thread Major pane in the narrow viewport.*
